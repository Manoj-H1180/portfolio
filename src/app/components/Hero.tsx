    ...
    <div className="her flex max-lg:flex-col justify-around bg-custom-dark dark:bg-custom-dark items-center px-8 pt-16 max-[350px]:px-4 md:pt-24 pb-16 md:pb-32 select-none min-h-screen">
      ...
      <div className="z-10 max-md:min-h-screen max-md:flex flex-col justify-center">
        <h1 className="lg:text-7xl text-5xl lg:pt-10 font-extrabold leading-tight tracking-tight scroll-m-20">
          ...
          <span className="xyz font-extrabold">Manoj</span> And i am{" "}
          <span>
        ...
        >
          <DownloadButton
            isHovered={isHovered}
            fileUrl="src/res/mytechresume.pdf"
          />
        </div>
      </div>
      ...
      <div className="flex flex-col justify-center items-center z-10 max-w-md lg:pt-24 pt-8 px-4 sm-px-8">
        ...
        <div className="flex lg:hidden h-16 gap-2 justify-between rounded-2xl dark:bg-[rgb(36,36,36,0.5)] backdrop-saturate-[180%] bg-[hsla(0,0%,100%,.8)] backdrop-blur-[5px] border-[1px] border-zinc-300 dark:border-zinc-700 px-4 w-[100%] mb-5 mx-auto items-center">
          <Link href={"https://www.linkedin.com/in/manoj1180/"} passHref>
            {" "}
            <div className="flex justify-center items-center rounded-full bg-gray-200 dark:bg-neutral-800 p-2">
              <SlSocialLinkedin className="text-2xl" />
            </div>{" "}
          </Link>

          <Link href={"https://github.com/Manoj-H1180"}>
            {" "}
            <div className="flex justify-center items-center rounded-full bg-gray-200 dark:bg-neutral-800 p-2">
