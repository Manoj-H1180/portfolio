...
const Skills = () => {
  ...
  return (
    <div>
      <div className="lg:text-6xl text-4xl pl-30 m-5 ml-8 lg:mb-10  font-bold">
      ...
      <div className="dark:bg-[#2e2e2e49] bg-zinc-100 py-12 mb-10 lg:mx-32 mx-6 rounded-2xl">
        <div
          ...
          className="dark:bg-[#2e2e2e49] bg-zinc-200 dark:shadow-none shadow-lg md:px-2 p-1  lg:mx-20 mx-7 md:mx-2  h-400px rounded-xl"
        >
          <h1 className="lg:text-3xl text-xl lg:ml-5 p-2 dark:text-slate-300">
            Web Development
          </h1>
        ...
        <div
          data-aos="zoom-out-up"
          className="dark:bg-[#2e2e2e49] bg-zinc-200 dark:shadow-none shadow-lg lg:mt-20 mt-6 md:px-2 p-1  lg:mx-20 mx-7 md:mx-2  h-400px rounded-xl"
        >
          <h1 className="lg:text-3xl text-xl lg:ml-5 p-2 dark:text-slate-300">
            Cloud Computing
          </h1>
        ...
        <div
          data-aos="zoom-out-up"
          className="dark:bg-[#2e2e2e49] bg-zinc-200 dark:shadow-none shadow-lg lg:mt-20 mt-6 md:px-2 p-1  lg:mx-20 mx-7 md:mx-2   rounded-xl"
        >
          <h1 className="lg:text-3xl text-xl lg:ml-5 p-2 dark:text-slate-300">
            Generative AI
          </h1>
